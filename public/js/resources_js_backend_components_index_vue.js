...
var render = function render() {
  ...
  }, [_vm._m(0), _vm._v(" "), _vm._m(1), _vm._v(" "), _vm.$store.getters.user ? _c("el-dropdown", {
    attrs: {
      trigger: "click"
    }
  }, [_c("span", {
  ...
  }, [_vm.$store.getters.user.roles ? _c("span", {
    staticStyle: {
      "font-size": "12px"
    }
  }, [_vm._v(_vm._s(_vm.$store.getters.user.roles[0]))]) : _vm._e()])]), _vm._v(" "), _c("el-divider", {
